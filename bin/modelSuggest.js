export const ROLE_ORDER = ["general", "coder", "vision"];
export const ROLE_DEFAULT_PROMPTS = {
...
export function classify(model) {
    ...
    const looksLikeCoder = model.capabilities.includes("insert") ||
...
export function suggestForRole(models, role) {
